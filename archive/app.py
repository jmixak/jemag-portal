...
def get_db_connection():
    return mysql.connector.connect(
        host="localhost",
        user="root",
        password="19950815",  # <-- Change this to your actual password!
...
menu = ["View Master Directory", "Log Student Evaluation", "Register New Profile"]
    ...
    if st.button("Save Profile"):
        if first_name and last_name and email:
            try:
                ...
                # Updated query to handle the separate phone variables
            ...
            st.warning("Please fill out all required fields (Name and Email).")